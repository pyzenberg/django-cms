...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserSettings', fields ['user', 'language']
        db.create_unique(u'cms_usersettings', ['user_id', 'language'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserSettings', fields ['user', 'language']
        db.delete_unique(u'cms_usersettings', ['user_id', 'language'])
    ...
    models = {
        ...
        'cms.usersettings': {
            'Meta': {'unique_together': "(('user', 'language'),)", 'object_name': 'UserSettings'},
